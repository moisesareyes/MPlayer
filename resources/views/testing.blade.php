                ...
                <div class="flex flex-col items-center pb-5">
                    ...
                    <div class="flex mt-4 md:mt-6">
                        ...
                        <form method="POST" action="{{route('editArtist')}}">
                            ...
                            <button type="submit" class="inline-flex ms-2 items-center px-4 py-2 text-sm font-medium text-center text-black bg-white rounded-lg hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-blue-300 hover:text-yellow-200"><svg class="w-6 h-6 text-gray-900 hover:text-yellow-200" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20"><path d="M1 5h1.424a3.228 3.228 0 0 0 6.152 0H19a1 1 0 1 0 0-2H8.576a3.228 3.228 0 0 0-6.152 0H1a1 1 0 1 0 0 2Zm18 4h-1.424a3.228 3.228 0 0 0-6.152 0H1a1 1 0 1 0 0 2h10.424a3.228 3.228 0 0 0 6.152 0H19a1 1 0 0 0 0-2Zm0 6H8.576a3.228 3.228 0 0 0-6.152 0H1a1 1 0 0 0 0 2h1.424a3.228 3.228 0 0 0 6.152 0H19a1 1 0 0 0 0-2Z"/></svg></button>
                ...
                <div class="max-w-screen-md">
                    <div class="grid gap-4 px-2.5 py-1.5">
                        <div class="flex justify-center items-center">
                            <img id='referencia' class="h-auto max-w-full rounded-lg" src="{{asset($newimg[0]->dir)}}" alt="{{$new->name}} Imagen">
                        </div>
